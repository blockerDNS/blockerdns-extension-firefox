...
## Install from Source
If you want to modify the code or play around with it, you can sideload it into Firefox. First download and extract the [ZIP file](https://github.com/blockerDNS/blockerdns-extension-firefox/archive/master.zip) or clone the repository.
```
git clone https://github.com/blockerDNS/blockerdns-extension-firefox.git
```
